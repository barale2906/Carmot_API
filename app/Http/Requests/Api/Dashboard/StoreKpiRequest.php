...
class StoreKpiRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'is_active' => 'boolean',
            'calculation_type' => 'required|in:predefined,custom_fields',
            ...
            'kpi_fields.*.field_type' => 'required_with:kpi_fields|in:numeric,integer,biginteger,string,text,date,datetime,timestamp,time,year,boolean,tinyint,decimal,float,double,json,longtext,mediumtext,char,varchar',
    ...
    public function messages(): array
    {
        return [
            ...
            'calculation_type.in' => 'El tipo de cálculo debe ser: predefined o custom_fields.',
            ...
            'kpi_fields.*.field_type.in' => 'El tipo de campo debe ser uno de los siguientes: numeric, integer, biginteger, string, text, date, datetime, timestamp, time, year, boolean, tinyint, decimal, float, double, json, longtext, mediumtext, char, varchar.',
