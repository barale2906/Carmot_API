...
/**
 * Validación para crear un proveedor de inventario.
 */
class StoreInvProveedorRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'razon_social' => [
                ...
                'string',
                'max:255',
                Rule::unique('inv_proveedores', 'razon_social')->whereNull('deleted_at'),
            ],
            'nit'          => [
                'nullable',
                'string',
                'max:20',
                Rule::unique('inv_proveedores', 'nit')->whereNull('deleted_at'),
            ],
