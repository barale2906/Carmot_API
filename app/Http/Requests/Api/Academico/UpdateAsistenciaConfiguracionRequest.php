...
class UpdateAsistenciaConfiguracionRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'curso_id' => ['sometimes', 'nullable', 'integer', 'exists:cursos,id'],
            'modulo_id' => ['sometimes', 'nullable', 'integer', 'exists:modulos,id'],
            'porcentaje_minimo' => ['sometimes', 'numeric', 'min:0', 'max:100'],
            'horas_minimas' => ['sometimes', 'nullable', 'integer', 'min:0'],
            'aplicar_justificaciones' => ['sometimes', 'boolean'],
            'perder_por_fallas' => ['sometimes', 'boolean'],
            'fecha_inicio_vigencia' => ['sometimes', 'nullable', 'date'],
            'fecha_fin_vigencia' => ['sometimes', 'nullable', 'date', 'after_or_equal:fecha_inicio_vigencia'],
