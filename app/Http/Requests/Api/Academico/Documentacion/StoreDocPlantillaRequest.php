...
/**
 * Valida la creación de una versión de plantilla de documento.
 *
 * @package App\Http\Requests\Api\Academico\Documentacion
 */
class StoreDocPlantillaRequest extends FormRequest
{
    /**
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            $noHabilitadas = app(DocVariableResolverService::class)
                ->variablesNoHabilitadas($this->input('contenido_html', ''), $tipoDocumento);
            ...
            $validos = $bloques->clavesValidas($tipoDocumento->entidad_type);
